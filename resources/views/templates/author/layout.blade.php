...
<head>
    ...
    <title>{{ "The Conf author Panel"}}</title>
...
<div class="container body">
    <div class="main_container">
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a hef="{{route('conferences.index')}}"><i class="fa fa-user"></i> Home </a></li>

                            <li><a><i class="fa fa-edit"></i> Conferences <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="{{route('conferencess.index')}}">All conferences</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li>
                                    ...
                                    <form id="logout-form" action="{{ url('/author/logout') }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                    </li>
                            </ul>
        ...
        <div class="right_col" role="main">
            @include('templates.author.partials.alerts')
            @yield('content')
        </div>
        <!-- /page content -->
